...
class OptionsListAdapter(private val pageFragmentViewModel: PageFragmentViewModel, var pagerposition: Int, private val callback:(Int, String) -> Unit ) : RecyclerView.Adapter<OptionsListAdapter.ViewHolder>()
{
